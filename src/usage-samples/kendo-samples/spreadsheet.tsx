...
import SpreadSheet from '../../components/kendo/spreadsheet';
import Panel from '../../components/panel';
import {ISpreadSheetProps} from '../../components/kendo/spreadsheet';
export default (props) => {

    let extraOptions: /*kendo.ui.SpreadsheetOptions*/ any = {
        excel: {
    ...
    const options:ISpreadSheetProps = {
        options: extraOptions
    };

    const style = { width: '100%' };
    return (
        <Panel heading="Kendo SpreadSheet example">
            <SpreadSheet
                options={options}
                style={style}
            />
